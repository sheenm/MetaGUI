...
it('renders static label', () => {
    ...
    const labelText: string = (div.querySelector('form label:nth-child(2)') as any).textContent
...
it('renders error when tries to use static and dynamic label at the same time', () => {
    ...
    const labelText: string = (div.querySelector('form span:nth-child(2)') as any).textContent
...
it('renders error textbox when no name', () => {
    ...
    const textbox = div.querySelector('form label:nth-child(2)')
...
it('renders static submit', () => {
    ...
    const submitText: string = (div.querySelector('form input:nth-child(2)') as any).value
...
it('renders complexForm', () => {
    ...
    const firstLabelText: string = (div.querySelector('form label:nth-child(2)') as any).textContent
    ...
    const secondLabelText: string = (div.querySelector('form label:nth-child(4)') as any).textContent
    ...
    const thirdLabelText: string = (div.querySelector('form label:nth-child(6)') as any).textContent
